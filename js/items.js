...
$(document).ready(function () {
  ...
  $('#item-2-telegram').dblclick(function () {
    window.open('https://t.me/zxcgirlcyka');
  });

  $('#item-2-love').dblclick(function () {
    window.open('https://images.pexels.com/photos/3825303/pexels-photo-3825303.jpeg?cs=srgb&dl=pexels-cottonbro-3825303.jpg&fm=jpg');
  });
